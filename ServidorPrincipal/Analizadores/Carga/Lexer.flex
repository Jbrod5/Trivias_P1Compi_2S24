...
package com.jbrod.servidorprincipal.analizadores.carga;
...
{trivias}   { return symbol(sym.TRIVIAS);   }
...
{usuarios} { return symbol(sym.USUARIOS); }
{usuario}  { return symbol(sym.USUARIO);  }
{password} { return symbol(sym.PASSWORD); }
{instituc} { return symbol(sym.INSTITUC); }
