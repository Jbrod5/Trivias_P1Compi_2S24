...
<body>
    <div class="container">
        <h1 class="text-center">Inicio de sesi&oacuten</h1>
        <br>
        <form class="text-center" action="Login" method="POST">
            <div class="editor-container" id="code-editor-container">
                <div class="line-numbers" id="lineNumbers"></div>
                <textarea name="login" class="form-control" id="login" rows="15" placeholder="Código de inicio de sesión" oninput="updateLineNumbers()" onkeyup="updateCursorPosition()"></textarea>
            </div>
            <div class="status" id="cursorPosition">Fila: 1  Columna: 1</div>
            <a href="../java/servlets/SvLogin.java"></a>
            <br>
            <button type="submit" class="btn btn-primary">Iniciar sesión</button>
            <br>
            ó
            <br>
            <a href="signup.jsp" class="btn btn-secondary">Registrarse</a>
        </form>
    </div>
